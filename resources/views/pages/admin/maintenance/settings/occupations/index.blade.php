<x-layout>
    ...
    <x-pageheader>Occupations</x-pageheader>
    ...
    <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-row w-full justify-between items-center">
            ...
            <div class="flex flex-row w-full items-center">
                <button id="add_occupation" class="ml-auto py-2 px-4 bg-project-yellow text-project-blue rounded-md text-sm flex items-center gap-2 font-bold"><i class='bx bx-xs font-bold bx-plus'></i>Add Occupation</button>
            </div>
        </div>
...
<div id="add_modal"  class="pl-16 absolute hidden flex inset-0 items-center justify-center min-h-[calc(100%)] min-w-[calc(100%)] flex-col bg-black/20 text-project-blue">
    <div class="flex flex-col w-3/4 min-h-10 bg-white rounded-md p-5 gap-7">
        <div class="flex justify-between">
            <p id="modal_title" class="text-lg font-bold">Add New Occupation</p>
        ...
        <button id="submit_settings" data-group="occupations" class="bg-project-yellow font-bold py-2 px-4 rounded-md">Add Occupation</button>
